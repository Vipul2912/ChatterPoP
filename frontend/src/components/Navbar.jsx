...
import { LogOut, MessageSquareHeart, Palette, UserRoundPen } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 h-16">
            ...
            <Link to="/" className="flex items-center gap-2.5 hover:opacity-80 transition-all">
              <div className="size-9 rounded-lg bg-primary/10 flex items-center justify-center">
                {/* <img src='/logo.svg' className="w-7 h-7 text-primary" /> */}
                {/* <FolderHeart className="w-7 h-7 text-primary"/> */}
                <MessageSquareHeart  className="w-7 h-7 text-primary"/>
              </div>
              <h1 className="text-lg font-bold">ChatterPoP™</h1>
            </Link>
          </div>
